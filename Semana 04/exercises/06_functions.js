...
var endFigure = suma(numberOne,numberTwo);
...
function addition(_num1, _num2, _message){
  ...
  var numberThree = 15;
  var numberFour = 'g';
  var message1 = 'error: los valores deben ser numéricos';
  ...
  alert('error: los valores deben ser numericos');
...
function addition2(_num1, _num2, _message){  
  ...
  var numberSix = 20;
  var numberSeven = 'h';
  var message2 = 'error: los valores deben ser enteros. ';
  var addition2 = addition3(numberSix,numberSeven,message2);
  
  console.log('Value 1: ' + numberSix);
  console.log('Value 2: ' + numberSeven);
